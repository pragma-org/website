      ...
      packages:
        ...
        - title: Reward calculations
          description: |
            ...
            blockchain which is commonly referred to as _the ledger state_. In
    ...
    - name: Full node
      ...
      packages:
        ...
        - title: Hard-fork combinator
          description: |
            Cardano's upgrade system is built around the well-known _Hard-Fork
            Combinator_. Behind this fancy term lies a piece of software which
        ...
        - title: Block forging
          description: |
            ...
            This is also referred to as _block forging_ and includes various
